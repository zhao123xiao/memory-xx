...
const targetCollection = argValue("--target-collection") || process.env.MEMORY_XX_LOCAL_EMBEDDING_COLLECTION || "memory-xx-default-v1";
const qdrantAlias = argValue("--alias") || process.env.MEMORY_XX_QDRANT_ALIAS || "memory-xx-active";
const redisPrefix = argValue("--redis-prefix") || process.env.MEMORY_XX_REDIS_PREFIX || "memory-xx-default-v1";
...
const embeddingModel = process.env.EMBEDDING_MODEL || "memory-xx-dev-embedding";
