...
export const FULL_STACK_CAPABILITIES: readonly FullStackCapability[] = [
  ...
  },
  {
    ...
    script_paths: ["scripts/generate-local-memory-embeddings.ts", "scripts/generate-embeddings.ts"],
  ...
  },
  {
    ...
    script_paths: ["scripts/memory-platform-doctor.ts", "scripts/memory-doctor.ts"],
  ...
  },
  {
    ...
    script_paths: ["scripts/qdrant-reconcile.ts", "scripts/fix-qdrant-replay.ts", "scripts/replay-qdrant-outbox.ts"],
  ...
  },
  {
    ...
    script_paths: ["scripts/runtime-observability-retention.ts", "scripts/trace-retention.ts"],
  ...
  },
  {
    ...
    script_paths: ["scripts/sweep-write-ticket-timeouts.ts", "scripts/archive-write-tickets.ts"],
